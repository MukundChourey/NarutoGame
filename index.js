...
function throwShuriken() {
  ...
  let shurikenSound = new Audio("assets/shurikenSound.mp3");
  shurikenSound.play();
  moveShuriken(shuriken);
}

let throww = "assets/kunai.gif";
let compensate = 0;
  ...
  let interval = setInterval(() => {
    ...
    ninjass.forEach((ninja) => {
      if (checkHit(shuriken, ninja)) {
        let chop = new Audio("assets/chop.mp3");
        chop.play();
        ninja.remove();
        shuriken.remove();
        ...
        if (parseInt(score) + 1 == 10) {
          naruto.src = "assets/NarutoPowerKyuubi.gif";
          setTimeout(() => {
            naruto.src = "assets/narutokyubimode.gif";
          }, 2500);
          naruto.style.height = "100px";
          music.pause();
          fastMusic();
          compensate = 40;
          throww = "assets/rasenshuriken.png";
          shurikenSpeed = 3;
          ninjaSpeed = 10;
          moveSpeed = 20;
        }
...
function checkHit(shuriken, ninja) {
  ...
  if (shurikenLeft + 35 >= ninjaLeft) {
    if (ninja.classList.contains('madara')) {
      console.log('madara');
    } else {
      console.log('else');
    }
...
let music = new Audio("assets/fighting.mp3");
let ninjaComing;
function start() {
...
function end() {
  ...
  naruto.src = 'assets/narutokunai.gif';
